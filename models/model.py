...
class DrugQDM(tq.QuantumModule):
    ...
    def add_time_embedding(self, x, t):
        bsz = x.shape[0]
        ...
        for i in range(bsz):
            ...
            current_x[0, start_pos:start_pos+embed_len] = t_embed[i]
            
            current_x = current_x / torch.norm(current_x)
    ...
    def sample_ddim(self, batch_size, ddim_steps=None, ddim_eta=None):
        ...
        x = torch.randn(batch_size, 2**self.n_qbits).to(device)
